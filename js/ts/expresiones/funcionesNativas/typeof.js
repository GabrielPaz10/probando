...
var Typeof = /** @class */ (function (_super) {
    ...
    Typeof.prototype.ejecutar = function (tsGlobal, tsLocal, metodos, entorno) {
        var expresion = this.expresion.ejecutar(tsGlobal, tsLocal, metodos, entorno);
        return { tipo: Tipos_1.Tipos.STRING, valor: (expresion.tipo) };
    };
    Typeof.prototype.ast = function (metodos) {
        return null;
    };
    return Typeof;
